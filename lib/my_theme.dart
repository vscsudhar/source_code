...
class MyTheme{
  ...
  static Color accent_color = Color.fromRGBO(79, 161, 67, 1.0);
  ...
  static Color splash_screen_color = Color.fromRGBO(84, 176, 86, 1.0); // if not sure , use the same color as accent color
